...
This is the one for that I chose to work on for this project. 
...
### Getting Started
1. Set up the Python environment Follow the instructions in the Udacity DRLND Github repository to set up the Python environment.
...
Follow the instructions in `Continuous_Control.ipynb` to get started with training the deep reinforcement learning agent.  
